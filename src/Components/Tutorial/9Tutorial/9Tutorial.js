...
// In place of class attribute we have to write className 
// Becuase class is reserve keyword.

// To import Google Fonts we have to import the link in the index.html
// and use that as usally we don in css non change.
